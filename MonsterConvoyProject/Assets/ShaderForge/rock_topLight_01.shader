...
///////// Gloss:
                ...
                float gloss = 1.0 - lerp(_RockGloss_var.rgb,_MossGloss_var.rgb,node_3375); // Convert roughness to gloss
                float perceptualRoughness = lerp(_RockGloss_var.rgb,_MossGloss_var.rgb,node_3375);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _RockGloss_var = tex2D(_RockGloss,TRANSFORM_TEX(i.uv0, _RockGloss));
                float4 _MossGloss_var = tex2D(_MossGloss,TRANSFORM_TEX(i.uv0, _MossGloss));
                float roughness = lerp(_RockGloss_var.rgb,_MossGloss_var.rgb,node_3375);
